...
export default function FooterSection() {
  return (
    <footer className="relative z-10 w-full bg-slate-950 py-32 px-4 flex flex-col items-center text-center overflow-hidden">
      ...
      <div className="scroll-reveal delay-200 group relative z-10 w-full max-w-[320px] md:max-w-md aspect-[9/16] rounded-3xl overflow-hidden cursor-pointer border border-slate-700/50 shadow-[0_30px_60px_rgba(0,0,0,0.8)] mb-24 transition-all duration-300 hover:shadow-[0_0_80px_rgba(74,222,128,0.4)] hover:-translate-y-2">
        <img loading="lazy" src="https://images.unsplash.com/photo-1611284446314-60a58ac0deb9?q=80&w=1080&auto=format&fit=crop" alt="Ocean pollution" className="absolute inset-0 w-full h-full object-cover transition-transform duration-300 group-hover:scale-110" />
        <div className="absolute inset-0 bg-black/60 transition-colors duration-300 group-hover:bg-black/30" />
        
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <div className="w-20 h-20 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 flex items-center justify-center transition-all duration-300 group-hover:bg-green-500 group-hover:border-green-400 group-hover:scale-125 group-hover:shadow-[0_0_40px_rgba(74,222,128,0.8)]">
